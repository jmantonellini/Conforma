Public Class Conexion
    ...
    Public Function tabla_clientes_por_empresa(ByVal filtro As String) As Data.DataTable
        Dim sql As String = "SELECT E.CUIT,E.NOMBRE AS 'NOMBRE_EMPRESA',C.NOMBRE AS 'NOMBRE_CLIENTE',C.APELLIDO AS 'APELLIDO_CLIENTE',C.EMAIL AS 'EMAIL',C.TEL_CEL as 'TEL_CEL' " _

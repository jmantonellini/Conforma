Public Class gestor_marcas_modelos
    ...
    Private Sub cmd_guardar_Click(sender As Object, e As EventArgs) Handles cmd_guardar.Click
        If Me.conexion.buscar_marcas(txt_marcas.Text.ToString).Rows.Count = 1 Then
        ...
        Else
            If Me.accion = tipo_grabacion.insertar Then
                ...
                End Try
            Else
                If Me.conexion.buscar_marcas(txt_marcas.Text.ToString).Rows.Count = 0 Then
                    Try
    ...
    Private Sub tabla_marcas_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles tabla_marcas.CellClick
        Me.marca = conexion.buscar_marcas(tabla_marcas.CurrentRow.Cells(1).Value)
